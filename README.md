...
# JetBrains splash screens[2026.2]
...
Path(路径)："lib\intellij.clion.main.nolang.jar\artwork\clion_splash@2x.png"

## 2 [GoLand](https://www.jetbrains.com/go/ )

![goland](img/goland_splash@2x.png)

Path(路径)："lib\intellij.goland.jar\artwork\splash@2x.png"

## 3 IntelliJ [IDEA](https://www.jetbrains.com/idea/) 

![idea](img/idea_logo@2x.png)

Path(路径)："lib\intellij.idea.ultimate.customization.jar\idea_logo@2x.png"
...
Path(路径)："lib\intellij.webstorm.branding.jar\artwork\webide_logo@2x.png"

## 8 [PhpStorm](https://www.jetbrains.com/phpstorm/ )

![phpstorm](img/phpstorm_webide_logo@2x.png)

Path(路径)："lib\intellij.php.resources.jar\artwork\webide_logo@2x.png"

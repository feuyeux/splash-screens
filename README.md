...
# JetBrains splash screens[2025.3]
...
Path(路径)："lib\product-backend.jar\artwork\clion_splash@2x.png"
...
Path(路径)："lib\product-backend.jar\idea_logo@2x.png"
...
Path(路径)："lib\app-backend.jar\artwork\webide_logo@2x.png"
